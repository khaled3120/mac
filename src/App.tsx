...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Once your deals are verified, your Macy's voucher code will be delivered to your email within 24\u201348 hours."
  }
];
...
export default function App() {
  return (
    <>
      ...
      {/* Top Banner */}
      <div className="w-full bg-[#E21B22] text-white text-center py-2 text-[11px] font-bold tracking-widest uppercase">
      ...
      <main className="flex-1 flex flex-col items-center w-full max-w-[400px] mx-auto px-4 pt-6 pb-8">
        ...
        {/* Logo */}
        <div className="h-[63px] mb-5 mt-1 flex justify-center items-center w-full">
           <img
            src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Macy%27s_logo.svg"
            alt="Macy's"
        ...
        <p className="text-gray-600 text-center mb-6 text-[13px]">
          Claim your <span className="font-bold text-black">$750</span> Macy's voucher
        </p>
        ...
        <div className="w-full flex flex-col gap-2.5 mb-7">
          {STEPS.map((step, index) => (
            ...
            >
              <div className="w-8 h-8 rounded-full bg-[#E21B22] text-white border-[1.5px] border-[#E21B22] flex items-center justify-center font-bold text-[13px] shrink-0 ml-3.5 mr-3.5">
                {index + 1}
              </div>
        ...
        {/* CTA */}
        <button 
           onClick={() => window.location.href = 'https://giftclick.org/aff_c?offer_id=3921&aff_id=144760'}
          className="w-full bg-[#E21B22] hover:bg-[#c7171e] active:bg-[#a61319] transition-colors text-white font-bold text-[15.5px] py-3.5 rounded-full shadow-[0_4px_14px_0_rgba(226,27,34,0.39)] hover:shadow-[0_6px_20px_rgba(226,27,34,0.23)] active:scale-[0.98] text-center block"
        >
          CLAIM NOW
        </button>
